...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="<?php echo e(URL::asset('css/internet_explorer.css')); ?>" rel="stylesheet">
  ...
  <body>
        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar"> 
           <!-- <li class="active"><a href="http://getbootstrap.com/examples/dashboard/#">Overview <span class="sr-only">(current)</span></a></li> -->
            <li  
				<?php if($_SERVER['SCRIPT_NAME'] == '/redCannon/public/admin/admin.php' ): ?>
				<?php echo "class=\"active\""; ?>
				<?php endif; ?>
			>
			<?php echo URL::link('All Post', 'admin.php'); ?>

			</li>
            <li><?php echo URL::link('All Users', 'admin.php'); ?></li>
            <li
				<?php if($_SERVER['SCRIPT_NAME'] == '/redCannon/public/admin/categories.php' ): ?>
				<?php echo "class=\"active\""; ?>
				<?php endif; ?>
			>
			<?php echo URL::link('All Categories', 'categories.php'); ?>
    ...
    <script src="<?php echo e(URL::asset('js/holder.min.js.download')); ?>"></script>
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <script src="<?php echo e(URL::asset('js/ie10-viewport-bug-workaround.js.download')); ?>"></script>
